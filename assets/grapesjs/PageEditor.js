...
function selectionLitteraire () {
  pageBlockManager.add('Sélection Littéraire', {
    label: 'Sélection Littéraire',
    content: `<section style="background: linear-gradient(180deg, #fafbff 0%, #fafbff 90%, #fff 90%);"> <div style="display: flex; gap: 2vw; justify-content: center;"> <div style="display: flex; flex-direction: column; gap: 2vw; align-items: start;"> <h2 style="color: #001689;font-family: Lato, sans-serif;font-weight: 600;font-size: 2.5vw;">La sélection littéraire</h2> <p style="text-transform: uppercase; background: #d2d9ff; color: #001689; padding: 6px 8px; font-family: Lato, sans-serif;font-size: .8vw; font-weight: 600; border-radius: 2px;"> Littérature</p><p style="font-family: Lato, sans-serif;font-size: 1vw;">Mollat vous invite à découvrir son petit marché de <br/> Noël solidaire : stand, cadeaux et concerts <br/> acoustiques vous y attendent. </p><button style="background: #001689; padding: 10px 25px;color: #fff; width: fit-content;border: none;font-size:1vw;">Découvrir</button> </div><div style="display: flex; gap: 1vw;"> <div style="display: flex; flex-direction: column; align-items: center; "> <img style="width: 100%; object-fit: contain; object-position: bottom center; margin-bottom: 1vw;" src="../../assets/grapesjs/Livre_1.jpg"> <p style="text-transform:uppercase;font-size:.8vw;padding: 4px 8px;color:#001689;background:#d2d9ff;font-family: Lato, sans-serif;margin-bottom: 1vw;align-self: start;"> Manga</p><p style=" font-style: italic;color: #001689;align-self: start;font-family: Lato, sans-serif; font-size: 1vw; font-weight: 800; margin-bottom: 1vw;"> 23€</p><p style="align-self: start; font-family: Lato, sans-serif; font-size: 1vw;">Commodo cupidatat irure qui consectetur aliquo.</p><p style="align-self: start; color: #001698; font-family: Lato, sans-serif; font-weight: 600; font-size: 1.1vw; margin-top: 1vw;"> En savoir plus</p></div><div style="display: flex; flex-direction: column; align-items: center; "> <img style="width: 100%; object-fit: contain; object-position: bottom center; margin-bottom: 1vw;" src="../../assets/grapesjs/Livre_2.jpg"> <p style="text-transform:uppercase;font-size:.8vw;padding: 4px 8px;color:#001689;background:#d2d9ff;font-family: Lato, sans-serif;margin-bottom: 1vw;align-self: start;"> Manga</p><p style=" font-style: italic;color: #001689;align-self: start;font-family: Lato, sans-serif; font-size: 1vw; font-weight: 800; margin-bottom: 1vw;"> 23€</p><p style="align-self: start; font-family: Lato, sans-serif; font-size: 1vw;">Commodo cupidatat irure qui consectetur aliquo.</p><p style="align-self: start; color: #001698; font-family: Lato, sans-serif; font-weight: 600; font-size: 1.1vw; margin-top: 1vw;"> En savoir plus</p></div></div></div><img src="../../assets/grapesjs/Ligne_block.svg" style="width: 80%; object-fit: contain; margin: 4vw auto;display: block;"> </section>`,
    attributes: {
      class: 'fa fa-custom fa-bookmark'
    }
  })
}
selectionLitteraire()
...
function whishlist () {
  pageBlockManager.add('whishlist', {
    label: 'whishlist',
    content: `<section> <div style="display: flex; gap: 2vw; justify-content: center;"> <div style="display: flex; flex-direction: column; gap: 2vw; align-items: start;"> <h2 style="color: #001689;font-family: Lato, sans-serif;font-weight: 600;font-size: 2.5vw;">Ma Whishlist</h2> <p style="font-family: Lato, sans-serif;font-size: 1vw;">Mollat vous invite à découvrir son petit marché de <br/> Noël solidaire : stand, cadeaux et concerts <br/> acoustiques vous y attendent. </p><button style="background: #001689; padding: 10px 25px;color: #fff; width: fit-content;border: none;font-size:1vw;">Accéder à ma Whishlist</button> </div><img src="../../assets/grapesjs/Wishlist.svg" style="width: 50%; object-fit: contain;"> </section>`,
    attributes: {
      class: 'fa fa-custom fa-list'
    }
  })
}
whishlist()
