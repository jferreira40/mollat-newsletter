...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 260px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="ml-4">
            <div class="dropdown">
                <a href="#" class="nav-link d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownOthers" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
